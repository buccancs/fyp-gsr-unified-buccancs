...
class TestSDKIntegrations(unittest.TestCase):
    ...
    def test_psychopy_integration_import(self):
        ...
        try:
            from src.integrations.psychopy_integration import (
                ExperimentController, StimulusLibrary)  # noqa: F401
    ...
    def test_lsl_stream_creation(self):
        ...
        try:
            ...
            # Try to create GSR stream (will fail gracefully if pylsl not
            # available)
    ...
    def test_shimmer_sensor_configuration(self):
        ...
        try:
            ...
            # Test configuration (should fail since not connected, but
            # shouldn't crash)
            result = sensor.configure_sensors(
                gsr=True, ppg=True, sampling_rate=128)
    ...
    def test_experiment_controller_stimulus_creation(self):
        ...
        try:
            ...
            # Try to initialize (will fail gracefully if PsychoPy not
            # available)
