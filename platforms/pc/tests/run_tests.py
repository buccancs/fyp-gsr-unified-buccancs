...
def run_unit_tests(verbose=False, coverage=False) -> None:
    """Run unit tests."""
...
def run_integration_tests(verbose=False) -> None:
...
def run_functional_tests(verbose=False) -> None:
...
def run_performance_tests(verbose=False) -> None:
...
def run_all_tests(verbose=False, coverage=False) -> None:
    """Run all tests."""
...
def run_specific_test(test_path, verbose=False) -> None:
