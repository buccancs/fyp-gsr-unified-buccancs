...
class RealTimeMonitor:
    ...
    def _collect_shimmer_metrics(self, shimmer, timestamp: float):
    ...
    def _collect_webcam_metrics(self, webcam, timestamp: float):
    ...
    def _check_performance_alerts(self, timestamp: float):
