...
interface AuthenticationProvider {
     ...
     */
    fun validateSession(sessionToken: String, deviceId: String): Boolean
     ...
     * @param deviceId Device ID
     */
    fun revokeSession(sessionToken: String, deviceId: String)
     ...
     */
    fun authorizeDevice(deviceId: String, deviceName: String): Boolean
