...
class Hdf5Exporter : DataExporter {
    ...
    private fun writeGroupInfoMessage(
        dataStream: DataOutputStream,
        numLinks: Int,
    ) {
    ...
    private fun writeDataspaceMessage(
        dataStream: DataOutputStream,
        size: Int,
        dimensions: Int,
    ) {
    ...
    private fun writeDatatypeMessage(
        dataStream: DataOutputStream,
        datatype: String,
    ) {
    ...
    private fun writeLayoutMessage(
        dataStream: DataOutputStream,
        dataSize: Int,
    ) {
    ...
    private fun writeUncompressedData(
        dataStream: DataOutputStream,
        series: DataExporter.DataSeries,
    ) {
