...
def setWorkspaceDirectory(stub):
    ...
    response = stub.SetWorkspaceDirectory(
        ShimmerGrpcAndOJC_pb2.StringMsg(message=newWorkspace)
    )
...
def showMenu(stub):
    ...
    if variable == "0":
        ...
        parseSdDataFromPath(
            stub,
            "C:/Users/Shimmer/Documents/StroKare_Workspace/Backup/2017-09-27_12.03.19",
        )
    elif variable == "8":
