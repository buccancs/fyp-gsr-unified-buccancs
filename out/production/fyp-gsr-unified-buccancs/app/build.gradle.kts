...
dependencies {
    ...
    // Additional Shimmer dev versions
    implementation(files("libs/shimmerbluetoothmanagerdev-0.10.27_alpha.jar"))
    implementation(files("libs/shimmerdriverdev-0.10.27_alpha.jar"))
    implementation(files("libs/shimmerdriverpcdev-0.10.27_alpha.jar"))
