...
class TestDeviceManager(unittest.TestCase):
    ...
    def test_disconnect_device(self):
        ...
        result = self.device_manager.disconnect_device(
            self.mock_device1.device_id)
    ...
    def test_collect_files(self):
        ...
        try:
            ...
            self.mock_device1.collect_files.return_value = [
                "file1.csv", "file2.mp4"]
            self.mock_device2.collect_files.return_value = [
                "file3.csv", "file4.mp4"]
            ...
            self.mock_device1.collect_files.assert_called_once_with(
                destination_dir)
            self.mock_device2.collect_files.assert_called_once_with(
                destination_dir)
    ...
    def test_get_all_device_statuses(self):
        ...
        status1 = {
            ...
            "is_connected": True}
        status2 = {
            "device_id": self.mock_device2.device_id,
            "is_connected": False}
...
class TestDeviceListener(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            self.device_listener.device_manager,
    ...
    def test_add_service(self, mock_inet_ntoa):
        ...
        self.device_listener.add_service(
            mock_zeroconf, service_type, service_name)
    ...
    def test_remove_service(self):
        ...
        self.device_listener.remove_service(
            mock_zeroconf, service_type, service_name)
