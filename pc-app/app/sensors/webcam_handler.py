...
class WebcamHandler:
    ...
    def start_capture(self, camera_index=0, resolution=(640, 480), fps=30):
        ...
        logger.info(f"Started webcam capture from index {camera_index} at {resolution} @ {fps}fps")
        return True
    ...
    def stop_recording(self):
        ...
        logger.info(f"Stopped recording. Saved {self.frame_count} frames to {self.recording_path}")
        self.recording_path = None
