...
class SessionManager:
    ...
    def _write_session_metadata(self, session_end: bool = False):
        ...
        metadata = {
            "session_id": self.session_id,
            "session_start_time": datetime.datetime.fromtimestamp(self.session_start_time).isoformat(),
            "session_directory": str(self.current_session_dir),
            "connected_devices": {
                device_id: {
                    "device_dir_name": info["device_dir_name"],
                    "registration_time": datetime.datetime.fromtimestamp(info["registration_time"]).isoformat(),
    ...
    def save_data(self, filename: str, data: str, device_id: Optional[str] = None, mode: str = 'w'):
        """
    ...
    def get_all_sessions(self) -> List[Dict[str, Any]]:
        ...
        return sorted(sessions, key=lambda x: x.get("session_start_time", ""), reverse=True)
