...
public class TcpClientTransport implements NetworkTransport {
    ...
    private boolean performHandshake() throws IOException {
        ...
        // exchange more information and possibly authenticate with the server.
        
        // Send the CONNECT message with the device ID
        String connectMessage = "CONNECT:" + deviceId;
        outputStream.write(connectMessage.getBytes());
        outputStream.flush();
        
        // In a real implementation, you would wait for a response from the server
        // and verify that the connection was accepted.
