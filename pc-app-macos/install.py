"""
macOS installation script for GSR Multimodal System - PC Controller
This script handles macOS-specific dependencies and provides installation guidance.
"""
...
def install_requirements():
    ...
    # Handle macOS Bluetooth dependencies
    print("\nInstalling macOS Bluetooth dependencies...")
    print("Installing bleak for macOS Bluetooth support...")
    ...
    try:
        ...
        print("  Ensure you have the latest version of pip and try again")

    # macOS-specific setup
    print("\nmacOS-specific setup...")
    print("macOS system configuration:")
    print("- Camera and microphone permissions may be required")
    print("- Grant permissions in System Preferences > Security & Privacy > Privacy")
    print("- For Bluetooth access, ensure Bluetooth is enabled in System Preferences")
    print("- You may need to allow the application in Security & Privacy settings")
    print("- For USB device access, ensure proper permissions are granted")
    print("- Consider installing Homebrew for additional system dependencies if needed:")
