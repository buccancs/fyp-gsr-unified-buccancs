"""
Linux installation script for GSR Multimodal System - PC Controller
This script handles Linux-specific dependencies and provides installation guidance.
"""
...
def install_requirements():
    ...
    # Handle Linux Bluetooth dependencies
    print("\nInstalling Linux Bluetooth dependencies...")
    print("Note: You may need to install system dependencies first:")
    ...
    try:
        ...
        print("✓ pybluez installed successfully for Linux Bluetooth support")
    except subprocess.CalledProcessError as e:
    ...
    print("\nPerforming Linux-specific setup...")
    print("Linux system configuration:")
    ...
    print("- For audio recording, ensure your user is in the 'audio' group")
    print("- Run: sudo usermod -a -G audio $USER")
    print("- Ensure udev rules are set up for USB devices if needed")
...
def check_dependencies():
    ...
    optional_modules = {
        "pybluez": "Bluetooth support (Linux)",
