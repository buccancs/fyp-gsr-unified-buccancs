...
class SecureNetworkWrapper(
    ...
    interface SecureNetworkCallback {
        fun onSecureMessageReceived(deviceId: String, message: String)
        fun onAuthenticationSuccess(deviceId: String)
        fun onAuthenticationFailed(deviceId: String, reason: String)
        fun onConnectionSecured(deviceId: String)
        fun onSecurityError(deviceId: String, error: String)
    }
     ...
     */
    fun sendSecureMessage(socket: Socket, deviceId: String, message: String): Boolean {
        ...
        return try {
            ...
            val secureMessage = JSONObject().apply {
    ...
    private fun createAuthRequest(deviceId: String, token: String): String {
    ...
    private fun createAuthResponse(deviceId: String, success: Boolean): String {
        return JSONObject().apply {
    ...
    private fun handleAuthResponse(authResponse: String, deviceId: String): Boolean {
        return try {
    ...
    private fun handleKeyExchange(keyExchange: String, deviceId: String) {
        try {
            ...
            activeSessions[deviceId] = SecureSession(
                deviceId = deviceId,
    ...
    private fun handleKeyExchangeResponse(keyResponse: String, deviceId: String): Boolean {
        return try {
