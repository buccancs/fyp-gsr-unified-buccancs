...
class AndroidAppInstrumentationTest {
    ...
    fun testApplicationContext() {
        ...
        assertEquals("Package name should match", "com.fypgsrunified.android", context.packageName)
    }
    ...
    fun testMemoryUsageIntegration() {
        ...
        assertTrue("Memory usage should be reasonable", finalMemory - initialMemory < 50 * 1024 * 1024) // 50MB threshold
    }
