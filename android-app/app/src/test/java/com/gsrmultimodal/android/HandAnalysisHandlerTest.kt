...
class HandAnalysisHandlerTest {
    ...
    fun testHandLandmarkEdgeCases() {
        ...
        val extremeLandmarks = listOf(
            ...
            HandAnalysisHandler.HandLandmark(Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE, Float.MAX_VALUE, "EXTREME_MAX"),
            HandAnalysisHandler.HandLandmark(Float.MIN_VALUE, Float.MIN_VALUE, Float.MIN_VALUE, Float.MIN_VALUE, "EXTREME_MIN")
        )
