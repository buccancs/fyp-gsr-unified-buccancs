...
class PerformanceMonitorTest {
    ...
    fun testMetricDataClass() {
        val metricData = PerformanceMonitor.MetricData(
            name = "test_metric",
    ...
    fun testPerformanceCallback() {
        ...
        val callback = object : PerformanceMonitor.PerformanceCallback {
            override fun onMetricsUpdated(metrics: Map<String, PerformanceMonitor.MetricData>) {
                callbackCalled = true
            }

            override fun onPerformanceAlert(metric: String, value: Double, threshold: Double) {
                // Alert callback
            }
        }
