package com.fpygsrunified.android.analysis

import android.content.Context
import android.graphics.Bitmap
import com.fpygsrunified.android.HandAnalysisHandler
...
class HandAnalysisHandlerTest {
    ...
    fun testHandLandmarkDataClass() {
        ...
        val landmark = HandAnalysisHandler.HandLandmark(
            x = 0.5f,
            y = 0.3f,
            z = 0.1f,
            visibility = 0.9f,
    ...
    fun testHandLandmarkWithExtremeValues() {
        ...
        val extremeLandmark = HandAnalysisHandler.HandLandmark(
            x = Float.MAX_VALUE,
            y = Float.MIN_VALUE,
            z = 0.0f,
            visibility = 1.0f,
    ...
    fun testPoseDataWithEmptyLandmarks() {
        ...
        val emptyPoseData = HandAnalysisHandler.PoseData(
            landmarks = emptyList(),
            confidence = 0.0f
        )
